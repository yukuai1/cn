...
| 	实例最大CPU使用率   |   %	 | -  |   单位时间内Redis实例所有Master节点中最大节点的CPU使用率   | 通过[describeMetricData](https://docs.jdcloud.com/cn/monitoring/api/describemetricdata)获取监控数据时，获取监控数据时，aggreType 设置为 max |   
