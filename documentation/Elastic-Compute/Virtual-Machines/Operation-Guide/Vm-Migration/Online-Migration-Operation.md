...
## 迁移许可配置
### 1、导入迁移许可
前往 [云市场](https://market.jdcloud.com/service/details/585174) 按源节点数量购买迁移许可，同一个源节点迁移至多个目标节点，仅消耗一个License。购买完成并通过京东云客服获得迁移许可后，点击 “系统管理”-“许可管理”页面中的 “添加” 将软件注册码填写在页面内，点击 “确定” 后即可在许可管理页面看到迁移授权的相关信息。
