...
-   API：[PutBucketACL](https://docs.jdcloud.com/cn/object-storage-service/api/put-bucket-acl-2?content=API)、
[GetBucketACL](https://docs.jdcloud.com/cn/object-storage-service/api/get-bucket-acl-2?content=API)
