...
|**templateName**|String|False| |模板标题。长度不超过 128 个字节。UTF-8 编码。|
|**snapshotType**|String|False| |模板类型。取值范围：<br>  sample - 采样截图模板<br>  sprite - 雪碧图模板<br>|
|**imageSampleConfig**|[ImageSampleConfig](updatesnapshottemplate#imagesampleconfig)|False| |采样截图模板配置|
|**imageSpriteConfig**|[ImageSpriteConfig](updatesnapshottemplate#imagespriteconfig)|False| |雪碧图模板配置|
