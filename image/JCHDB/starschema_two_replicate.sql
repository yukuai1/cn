...
ENGINE = ReplicatedMergeTree('/clickhouse/default/tables/customer_local/{shard}', '{replica}') ORDER BY (C_CUSTKEY);
...
ENGINE = ReplicatedMergeTree('/clickhouse/default/tables/lineorder_local/{shard}', '{replica}') PARTITION BY toYear(LO_ORDERDATE) ORDER BY (LO_ORDERDATE, LO_ORDERKEY);
...
ENGINE = ReplicatedMergeTree('/clickhouse/default/tables/part_local/{shard}', '{replica}') ORDER BY P_PARTKEY;
...
ENGINE = ReplicatedMergeTree('/clickhouse/default/tables/supplier_local/{shard}', '{replica}') ORDER BY S_SUPPKEY;
...
ENGINE = ReplicatedMergeTree('/clickhouse/default/tables/lineorder_flat_local/{shard}', '{replica}')
