...
- 根据需求选择节点，运营商，带宽计费模式（支持按包年包月、按配置、加入共享带宽3种计费方式），线路类型，带宽上限，IP类型(IPv4和IPv6)，额外带宽上限，购买时长和数量，点击 **确定** 按钮，即可创建1个弹性公网IP。<br/>
...
- 限制条件：EIP IPv4支持绑定开通内网IPv4或别名IPv4的分布式云物理服务器资源<br/>
