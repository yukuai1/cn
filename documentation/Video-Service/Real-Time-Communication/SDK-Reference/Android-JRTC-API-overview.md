...
+ ### 房间相关
    ...
    - #### enterRoom
        ...
        |参数||
        |---|---|
        |joinroomInfo|JRTCJoinRoomInfo{<br>userRoomId : 房间号<br>nickName : 昵称<br>appId : appid<br>token : token<br>userId : userid<br>nonce : nonce<br>timestamp : 时间戳<br>recordFileName: 录制文件名<br>liveStreamName: 转推直播流名<br>}<br>用户token计算<br>https://docs.jdcloud.com/cn/real-time-communication/sdk/generate-user-token
