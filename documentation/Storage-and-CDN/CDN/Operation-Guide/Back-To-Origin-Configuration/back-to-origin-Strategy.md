...
添加域名后，点击【加速域名】进入域名配置基本信息，可输入【回源配置】信息，回源方式分为IP回源、域名回源、oss回源三种。中国境内加速域名支持ip回源和域名回源自定义端口，如1.1.1.1:80；中国境外/全球加速域名暂不支持配置自定义端口，源站端口选择80时默认支持80、8080、8880、2052、2082、2086、2095，源站端口选择443时默认支持443、2053、2083、2087、2096、8443。
