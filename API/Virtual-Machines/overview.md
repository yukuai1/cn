...
## 简介
云主机实例、镜像、SSH密钥、实例模板、规格类型、配额相关的接口。
...
|[**detachNetworkInterface**](https://docs.jdcloud.com/cn/virtual-machines/api/detachnetworkinterface?content=API)|POST|为云主机缷载一块弹性网卡。<br>|
...
|[**describeImages**](https://docs.jdcloud.com/cn/virtual-machines/api/describeimages?content=API)|GET|查询镜像信息列表，包括镜像来源、名称、ID。<br>|
|[**describeImage**](https://docs.jdcloud.com/cn/virtual-machines/api/describeimage?content=API)|GET|查询镜像详情，包括镜像ID、名称、操作系统等。<br>|
...
|[**describeImageMembers**](https://docs.jdcloud.com/cn/virtual-machines/api/describeimagemembers?content=API)|GET|查询私有镜像共享帐户列表。<br>|
...
|[**createInstanceTemplate**](https://docs.jdcloud.com/cn/virtual-machines/api/createinstancetemplate?content=API)|POST|创建指定参数的实例模板。<br>|
|[**describeInstanceTemplates**](https://docs.jdcloud.com/cn/virtual-machines/api/describeinstancetemplates?content=API)|GET|查询实例模板列表，包括实例模板ID、名称、描述、详细配置等。<br>|
|[**describeInstanceTemplate**](https://docs.jdcloud.com/cn/virtual-machines/api/describeinstancetemplate?content=API)|GET|查询实例模板详情，包括实例模板ID、名称、描述、详细配置等。<br>|
