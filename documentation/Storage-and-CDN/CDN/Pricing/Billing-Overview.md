...
预付费购买流量包的模式，购买当日即刻生效，过期后作废，使用后不支持退款。[**点击购买**](https://common-buy.jdcloud.com/resource/create?serviceCode=cdnbag)
...
对于无法正常抵扣流量包的用量，将产生计费账单进行账户余额抵扣，若触发欠费停服规则（详情请查看[**欠费说明**](https://docs.jdcloud.com/cn/cdn/arrears)），将导致CDN账号业务停用，所有加速域名回源处理，为保障您的业务稳定，请及时关注流量包余量、抵扣情况。
