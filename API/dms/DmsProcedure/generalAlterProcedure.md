...
## 请求地址
https://dms.jdcloud-api.com/v1/regions/{regionId}/procedure:generalAlter
...
|名称|类型|是否必需|默认值|描述|
|---|---|---|---|---|
|**dataSourceId**|Integer|False| |数据源id|
|**dbName**|String|True| |数据库名称。|
|**originProcedureName**|String|True| |原存储过程名称。|
|**procedureName**|String|False| |存储过程名称。|
|**definer**|String|False| |定义者。|
|**procedureSecurity**|String|False| |安全性，DEFAULT("DEFAULT", 1),DEFINER("DEFINER", 2), INVOKER("INVOKER", 3);|
