...
| Domain         | string | 是   | general                               | 模型领域： - general，通用日常识别场景，需要使用 16000 Hz 采样率的音频 |
...
| sample_rate      | int    | 是   | 16000  | 音频采样率： - 对于通用场景仅支持 16kHz，填 16000            |
...
建议您使用我们提供的 SDK 进行调用，SDK 获取及调用方式详见本页接口描述中的 [4.接口使用](https://aidoc.jd.com/speech/realtime_asr.html### 4. 接口使用)
